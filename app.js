...
//app.use(require("express-form-data").parse())
 ...
 app.use('/profile', upload.single('blob'), function (req, res, next) {
...
app.use('/mergeframes', upload.single('monem'),function(req, res) {
  console.log(req)
...
app.use('/proxypost',upload.single('blob'), function(req, res,next) {
